...
@app.route('/get/<person_id>/', defaults={'hierarchy':None})
@app.route('/get/<person_id>/<hierarchy>/')
def get_route(person_id, hierarchy):
    global data_api
    response = make_response(data_api.get(person_id, hierarchy), 200)
